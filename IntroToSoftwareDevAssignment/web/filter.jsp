                ...
                <c:set var="Movies">
                    <Movies>
                        <%
                            ...
                            String keyword = "";
                            if (request.getParameter("Action").equals("Action")) {
                                keyword = "Action";
                            }
                            if (request.getParameter("Adventure").equalsIgnoreCase("Adventure")) {
                                keyword = "Adventure";
                            }
                            if (request.getParameter("Family").equalsIgnoreCase("Family")) {
                                keyword = "Family";
                            }

                            DBManager db = (DBManager) session.getAttribute("manager");
                            ArrayList<Movie> list = db.filterGenre(keyword);
