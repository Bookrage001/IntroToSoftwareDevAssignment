...
INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('kquin', 'kquin', 'kaydee@mail.com', 'Kaydee', 'Quintero', '1/46 Coles Parade', 'Manly Vale', '2093', 'Staff', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('asny', 'asny', 'ayat@mail.com', 'Ayat', 'Snyder', '1/28 Dork Parade', 'Dee Why', '2099', 'Staff', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('hcarlson', 'hcarlson', 'hanifa@mail.com', 'Hanifa', 'Carlson', '11 Koorala Street', 'Manly Vale', '2093', 'Staff', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('mwagstaff', 'mwagstaff', 'mysha@mail.com', 'Mysha', 'Wagstaff', '56 Brode Way', 'Balgowlah', '2095', 'Staff', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('hclaud', 'hclaud', 'hclaud@mail.com', 'Hayley', 'Claud', '1/28 Rose Street', 'Freshwater', '2096', 'Admin', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('lmagallanes', 'lmagallanes', 'leanne@mail.com', 'Leanne', 'Magallanes', '14 Pacific Parade', 'Dee Why', '2099', 'Admin', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('chadeguzman', 'chadeguzman', 'chacha@mail.com', 'Charis', 'DeGuzman', '13 Sturdee Parade', 'Dee Why', '2099', 'Admin', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('ksalvania', 'ksalvania', 'karyl@mail.com', 'Karyl', 'Salvania', '1 Oxford Falls Street', 'Beacon Hill', '2100', 'Admin', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('jreber', 'jreber', 'jonah@mail.com', 'Jonah', 'Reber', '399 Condamine Street', 'Allambie Heights', '2100', 'Admin', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('aelston', 'aelston', 'ashleigh@mail.com', 'Ashleigh', 'Elston', '65 Quirk Road', 'Manly Vale', '2093', 'User', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('slypig', 'slypig', 'cunningham@mail.com', 'Daniel', 'Cunningham', '65 Quirk Road', 'Manly Vale', '2093', 'User', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('atolentino', 'atolentino', 'alexie@mail.com', 'Alexie', 'Tolentino', '89 Fairway Close', 'Manly', '2095', 'User', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('lcarlos', 'lcarlos', 'logan@mail.com', 'Logan', 'Carlos', '12 Nuglas Way', 'Cromer', '2099', 'User', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('struong', 'struong', 'skye@mail.com', 'Skye', 'Truong', '45 High Street', 'Curl Curl', '2096', 'User', 'Active');

INSERT INTO USERS (USERNAME, PASSWORD, EMAIL, FIRST_NAME, LAST_NAME, ADDRESS, SUBURB, POSTCODE, "TYPE", STATUS) 

	VALUES ('afoster', 'afoster', 'ana@mail.com', 'Anastasia', 'Foster', '18 Kit Parade', 'Cromer', '2099',
