...
<%
    ...
    db.executequery("UPDATE USERS SET USERNAME='" + username + "',FIRST_NAME='" + first_name + "',LAST_NAME='" + last_name +
            "',EMAIL='" + email +"',PASSWORD='" + password +"',ADDRESS='" + address +"',SUBURB='" + suburb +"',POSTCODE='" + postcode 
            +"',TYPE='" + type +"'WHERE USERNAME='" + username + "'");
    }
    else {
        db.executequery("UPDATE USERS SET USERNAME='" + username + "',FIRST_NAME='" + first_name + "',LAST_NAME='" + last_name +
            "',EMAIL='" + email +"',PASSWORD='" + password +"',ADDRESS='" + address +"',SUBURB='" + suburb +"',POSTCODE='" + postcode + "'WHERE USERNAME='" + username + "'");
    }
